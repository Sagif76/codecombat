...
#  ozaria_home:
subtitle: "Informatyka która oczarowuje"
heading_subtitle: "Przygoda z kodowaniem dla studentów i gotowe rozwiązanie do nauczania informatyki."
item_list_p: "Zagraj w Etap1 za darmo"
engaging_heading_corner: "Rozwiązanie angażujące uczniów i wspierające nauczycieli"
engaging_row1_h2: "Łatwe włączenie do zajęć"
engaging_row1_p: "Nawet jeśli nie masz doświadczenia w kodowaniu, z Ozarią możesz prowadzić pełny program nauczania informatyki. Nasze gotowe plany lekcji i intuicyjny panel zapewnią Ci narzędzia, których potrzebujesz, aby być gotowym do nauczania już od pierwszego dnia."
engaging_row2_h2: "Wciągająca rozgrywka"
engaging_row2_p: "Uczniowie są zanurzeni w grze przygodowej, w której ich wiedza z zakresu informatyki rozwija się wraz z fabułą. W tym wciągającym środowisku edukacyjnym uczniowie rozwijają umiejętności przydatne w świecie rzeczywistym dzięki sile zabawy."
engaging_row3_h2: "Program nauczania dostosowany do standardów"
engaging_row3_p: "Ozaria spełnia standardy CSTA i ISTE, dzięki czemu możesz uczyć z pewnością siebie, podczas gdy Twoi uczniowie opanowują podstawowe koncepcje informatyki, rozwijają umiejętności myślenia obliczeniowego i dowiadują się o znaczeniu informatyki w ich codziennym życiu."
